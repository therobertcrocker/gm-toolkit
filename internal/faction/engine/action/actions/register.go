...
func RegisterDefaultActions(e *engine.Engine) {
	...
	e.Action.Register(func(c action.Collector) action.Action { return NewBuyAsset(c, e.Hooks) })
	e.Action.Register(func(c action.Collector) action.Action { return NewRefitAsset(c) })
	e.Action.Register(func(c action.Collector) action.Action { return NewAttack(c, e.Rand, e.Hooks) })

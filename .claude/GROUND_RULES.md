...
6. Maintain semantic versioning. After every branch merge, assess whether the work warrants a patch (bug fix), minor (new feature), or major (breaking change) bump and tag accordingly. Current version: v0.2.0.
